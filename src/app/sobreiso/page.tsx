    ...
    <>
      ...
      <section className="py-20 bg-gradient-to-b from-white to-slate-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          {/* O que é um padrão */}
          <div className="rounded-2xl border-2 border-[#00847e]/20 bg-gradient-to-br from-[#00847e]/5 to-transparent p-8 mb-16">
            ...
            {SOLUTIONS.map((solution, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Icon */}
                  <div className="w-14 h-14 rounded-xl bg-[#00847e]/10 flex items-center justify-center flex-shrink-0 mb-5 group-hover:bg-[#00847e]/20 transition-colors duration-300">
                    <IconComponent className="h-6 w-6 text-[#00847e]" />
                  </div>

                  {/* Title */}
                  <h4 className="font-semibold text-slate-900 text-lg leading-snug mb-4">
                    {t(solution.titleKey)}
                  </h4>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 text-[#00847e] font-semibold text-sm group/link hover:gap-3 transition-all duration-300"
                  >
                    {t('common.learn_more')}
